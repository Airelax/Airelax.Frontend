<template>
  <div class="row top">
    <div class="col-md-6 col-12 position-relative">
      <div class="back" v-if="fullWidth<768">
        <a href="#"><img src="@/assets/pic/icon/back.svg"></a>
        <div class="date"> {{ StartDate }}9月1號 - {{ EndDate }}9月2號 ·
          {{ TravelerCount }}2位房客 | <img src="@/assets/pic/icon/setting.svg"></div>
      </div>
      <div class="ms-5">
        <div class="text-start m-md-4 px-3 pt-3">
          <p>
            {{ RoomCount }}300多間住宿 · {{ StartDate }}9月1號 - {{ EndDate }}9月2號 ·
            {{ TravelerCount }}2位房客
          </p>
          ...
          <div class="my-2 ms-3 fs-6">顯示「{{}}」的搜尋結果</div>
        </div>
        <div class="RoomType">
    ...
    <div class="col-6" v-if="fullWidth>768">
      <img src="https://images.pexels.com/photos/981153/pexels-photo-981153.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260" class="w-100">
    </div>
...
import ResultRoom from '../components/_Cyuan/ResultRoom';
import BrowsingRecord from '../components/_Cyuan/BrowsingRecord';
export default {
  created() {
    axios
      .get(
