                ...
                <div class="row sticky-section">
                    <div class="col-12 col-md-7">
                        ...
                        <div class="dateBottom">
                            <keep-alive>
                                <Date :newdate="pickDate" @outpass='outpassVal' :same="samepass"></Date>
                            </keep-alive>
                        </div>
                    </div>
                    <div class="col-12 col-md-5 price-sticky">
                        <div class="price">
                           <div class="mix">
                            ...
                            <keep-alive>
                                <DatePicker v-if="fullWidth > 768" @update="updateChoice" :pass="outpass"></DatePicker>
                            </keep-alive>

                            <button v-if="Object.keys(pickDate).length === 0 && Object.keys(outpass).length === 0 " data-bs-toggle="modal" data-bs-target="#myModal" @click="isDateShow = true">查看可訂日期</button>
                            <button v-else>預定</button>

                            <div class="hide-price" v-if="fullWidth > 768 && Object.keys(pickDate).length !== 0">
                ...
                <div class="col-12 col-md-6">
                    <div class="landlord">
                       ...
                       <div class="security">
                           ...
                           <div class="icon"><img src="../assets/pic/icon/security.svg"></div>
                       </div>
                    </div>
                </div>
            </div>
               ...
               <div class="rule-section">
                   ...
                   <a data-bs-toggle="modal" data-bs-target="#myModal" @click="isDatePickerShow = true" class="regulation main">
                       <div class="txt">
                           ...
                           <Cancel v-if="fullWidth > 768 && Object.keys(pickDate).length !== 0"></Cancel>
                       </div>
                       <div class="arrow">></div>
                   </a>
               </div>
                ...
                <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered modal-fullscreen-md-down">
                    <div class="modal-content">
                        <button type="button" class="btn" data-bs-dismiss="modal" aria-label="Close" @click="invisible">
                            <img src="../assets/pic/icon/back.svg">
                        </button>
                    <div class="modal-body">
                        ...
                        <keep-alive>
                            <Date v-if="isDateShow" :newdate="pickDate" @same='sameVal' ></Date>
                        </keep-alive>
...
import Picture from '../components/_Howard/Picture';
import Share from '../components/_Howard/Share';
import Description from '../components/_Howard/Decsription';
import Facility from '../components/_Howard/Facility';
import Date from '../components/_Howard/Date';
import Connect from '../components/_Howard/Connect';
import HouseRule from '../components/_Howard/HouseRule';
import Healthy from '../components/_Howard/Healthy';
import Location from '../components/_Howard/Location';
